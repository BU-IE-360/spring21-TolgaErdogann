...
```{r}
auto.arima(earphone_daily_additive$random, seasonal = FALSE)
...
```{r}
model_forecast_error <- predict(earphone_model2, n.ahead = 10)$pred
last_trend_value <-tail(earphone_daily_additive$trend[!is.na(earphone_daily_additive$trend)],1)
seasonality=earphone_daily_additive$seasonal[295:304]
...
```{r}
auto.arima(vacuum_daily_additive$random, seasonal = FALSE)
...
```{r}
model_forecast_error <- predict(vacuum_model, n.ahead = 10)$pred
last_trend_value <-tail(vacuum_daily_additive$trend[!is.na(vacuum_daily_additive$trend)],1)
seasonality=vacuum_daily_additive$seasonal[295:304]
...
```{r}
auto.arima(facial_cleanser_daily_additive$random, seasonal = FALSE)
...
```{r}
model_forecast_error <- predict(facial_cleanser_model, n.ahead = 10)$pred
last_trend_value <-tail(facial_cleanser_daily_additive$trend[!is.na(facial_cleanser_daily_additive$trend)],1)
seasonality=facial_cleanser_daily_additive$seasonal[295:304]
...
```{r}
facial_cleanser_daily_te$error5<-paste(abs(facial_cleanser_daily_te$sold_count-facial_cleanser_daily_te$forecastarimax))
facial_cleanser_daily_te$error5<-as.numeric(facial_cleanser_daily_te$error5)
n=length(facial_cleanser_daily_te$sold_count)
MAD= sum(facial_cleanser_daily_te$error5)/n
WMAPE5= MAD/mean(facial_cleanser_daily_te$sold_count)
WMAPE5
```
...
```{r}
auto.arima(babywipe_daily_additive$random)
...
```{r}
model_forecast_error <- predict(babywipe_model2, n.ahead = 10)$pred
last_trend_value <-tail(babywipe_daily_additive$trend[!is.na(babywipe_daily_additive$trend)],1)
seasonality=babywipe_daily_additive$seasonal[295:304]
...
```{r}
babywipe_daily_te$error5<-paste(abs(babywipe_daily_te$sold_count-babywipe_daily_te$forecastarimax))
babywipe_daily_te$error5<-as.numeric(babywipe_daily_te$error5)
n=length(babywipe_daily_te$sold_count)
MAD= sum(babywipe_daily_te$error5)/n
WMAPE5= MAD/mean(babywipe_daily_te$sold_count)
WMAPE5
```
...
```{r}
model_forecast_error <- predict(mont_model2, n.ahead = 10)$pred
last_trend_value <-tail(mont_daily_additive$trend[!is.na(mont_daily_additive$trend)],1)
seasonality=mont_daily_additive$seasonal[295:304]
...
```{r}
model_forecast_error <- predict(oralb_model2, n.ahead = 10)$pred
last_trend_value <-tail(oralb_daily_additive$trend[!is.na(oralb_daily_additive$trend)],1)
seasonality=oralb_daily_additive$seasonal[295:304]
...
```{r}
model_forecast_error <- predict(bikini1_model2, n.ahead = 10)$pred
last_trend_value <-tail(bikini1_daily_additive$trend[!is.na(bikini1_daily_additive$trend)],1)
seasonality=bikini1_daily_additive$seasonal[295:304]
...
```{r}
model_forecast_error <- predict(bikini2_model2, n.ahead = 10)$pred
last_trend_value <-tail(bikini2_daily_additive$trend[!is.na(bikini2_daily_additive$trend)],1)
seasonality=bikini2_daily_additive$seasonal[295:304]
...
```{r}
auto.arima(tayt_daily_additive$random, seasonal = FALSE)
...
```{r}
model_forecast_error <- predict(tayt_model, n.ahead = 10)$pred
last_trend_value <-tail(tayt_daily_additive$trend[!is.na(tayt_daily_additive$trend)],1)
seasonality=tayt_daily_additive$seasonal[295:304]
